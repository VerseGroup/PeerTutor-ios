//
//  CreateLearningRequestViewModel.swift
//  PeerTutor
//
...
class CreateLearningRequestViewModel: ObservableObject {
    ...
    func createRequest() {
        if let user = userManager.currentUser,
           let course = selectedCourse {
            userManager.requestMatch(user: user, course: course, relationship: false)
            requestSuccess = true
        }
    }
}
