...
class DeveloperPreview {
    ...
    let matchRequest1 = MatchRequest(id: 1, user: User(id: 1, username: "user1", email: "user1@gmail.com", permission: 1, grade: 10, joinDate: "lol", frees: [Period.d1p2, Period.d1p3], teachableGrades: [9,10,11,12]), course: Course(id: 1, name: "Math", description: "I love math :)"), relationship: true)
}
